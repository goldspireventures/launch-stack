...
export function TemplateDemoLinks({ templateId }: { templateId: string }) {
  ...
  if (!demo && !productUrl && !portal) return null;
  ...
  return (
    <div className="rounded-2xl border border-border/60 bg-card/40 p-5">
      ...
      <p className="mt-1 text-xs leading-relaxed text-muted-foreground">
        ...
        environment. Fixed-price starting points today: dating and clinic booking; other shapes are quoted
        per proposal.
      </p>
        ...
        {portal ? (
          <li>
            ...
            <p className="mt-0.5 text-xs text-muted-foreground">
              How clients follow timeline, documents, and payments after contract.
            </p>
          </li>
        ) : null}
      </ul>
